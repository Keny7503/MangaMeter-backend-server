const data = {
  ...
  // Filter for tags with group "genre"
  const genreTags = data.data.filter(tag => tag.attributes.group === "genre");
  
  // Print tag name and id
  genreTags.forEach(tag => {
    console.log(`Tag Name: ${tag.attributes.name.en}, ID: ${tag.id}`);
  });